...
function HomePage() {
  ...
  return (
    <div style={{ textAlign: 'center', paddingTop: '60px', backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
      <Helmet>
      ...
      <nav style={{ position: 'fixed', top: 0, width: '100%', backgroundColor: '#fff', borderBottom: '1px solid #ddd', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem 2rem', zIndex: 1000 }}>
        <img src="/logo.png" alt="XLMGuard Logo" style={{ height: '40px' }} />
        <div>
          <Link to="/faq" style={{ margin: '0 1rem' }}>FAQ</Link>
          <button onClick={() => navigate('/instructions')} style={{ marginRight: '1rem' }}>Instructions</button>
      ...
      <footer style={{ marginTop: '3rem', padding: '1rem 0', fontSize: '0.8rem', color: '#777', borderTop: '1px solid #ddd' }}>
